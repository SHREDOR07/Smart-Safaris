...
const DashboardPage = () => {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div
        className="relative px-4 pt-10 pb-16 mb-[-2rem] overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-background/60 via-background/50 to-background pointer-events-none" />

        <div className="relative z-10 flex items-center justify-between mb-2">
          <div>
            <p className="text-foreground/70 text-sm">Welcome back,</p>
            <h1 className="text-3xl font-display font-bold text-foreground drop-shadow-lg">
              {profile?.full_name || "Traveler"}
            </h1>
          </div>
          <div className="rounded-full bg-primary/20 border border-primary/30 p-2 backdrop-blur-sm">
